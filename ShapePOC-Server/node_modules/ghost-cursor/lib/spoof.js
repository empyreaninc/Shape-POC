        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3:
                    ...
                    return [4, ((_c = elementFrame.parentFrame()) === null || _c === void 0 ? void 0 : _c.$x('//iframe'))];
                case 4:
                    _a = _d.sent();
                    return [3, 6];
                case 5:
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 7:
                            ...
                            return [3, 8];
                        case 8:
                            if (!((options === null || options === void 0 ? void 0 : options.moveDelay) !== undefined && options.moveDelay >= 0)) return [3, 10];
                            return [4, delay(Math.random() * options.moveDelay)];
                        case 9:
                            _a.sent();
                            return [3, 12];
                        case 10: return [4, delay(Math.random() * 2000)];
                        case 11:
                            _a.sent();
                            _a.label = 12;
                        case 12:
                                ...
                                return __generator(this, function (_c) {
                                    switch (_c.label) {
                                        case 0:
                                            ...
                                            return [4, page.waitForXPath(selector, {
                                                    timeout: options.waitForSelector
                                                })];
                                        case 1:
                                            _c.sent();
                                            _c.label = 2;
                                        case 2: return [4, page.$x(selector)];
                                        case 3:
                                        ...
                                        case 13:
                                            e_3 = _c.sent();
                                            console.debug('Falling back to JS scroll method', e_3);
